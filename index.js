  ...
  if(message.guild) {
      if(command == "setup") {
        ...
        if(message.channel.parentID == message.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
          ...
          channel.send("<@&745886849142358016>", nembed)
...
.setAuthor('From Space Support')
  ...
  if(!message.guild) {
      ...
      if(!main) {
          ...
          .setColor("GREEN")
          .setThumbnail(client.user.displayAvatarURL({dynamic: true}))
          .setDescription(`Hi ${message.author.tag} Conversation is now started, you will be contacted by Supports From SpaceBot`)
        ...
        return mx.send("<@&745886849142358016>", eembed)
      }
